...
#track = p.loadSDF("bullet_buggy/f10_racecar/meshes/barca_track.sdf", globalScaling=1)
otherCar = p.loadURDF("bullet_buggy/f10_racecar/racecar_differential.urdf", [0, 1, .3])
car = p.loadURDF("bullet_buggy/f10_racecar/racecar_differential.urdf", [0, 0, .3])
