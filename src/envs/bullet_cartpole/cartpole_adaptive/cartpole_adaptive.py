...
class CartPoleAdaptiveBulletEnv():
    metadata = {
        'render.modes': ['human'],
    }
    ...
    def __init__(self, animate=False, max_steps=200, seed=None):
        ...
        self.cartpole = p.loadURDF(os.path.join(os.path.dirname(os.path.realpath(__file__)), "cartpole_adaptive.urdf"))
...
if __name__ == "__main__":
    env = CartPoleAdaptiveBulletEnv(animate=True)
    env.demo()